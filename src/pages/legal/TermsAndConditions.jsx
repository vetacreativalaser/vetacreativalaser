        ...
        >
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Para realizar un pedido, por favor contacta a través de los medios indicados en la web. El pago se realiza mediante Bizum o transferencia bancaria o enlace de pago en la web. 
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Debido a la naturaleza personalizada de muchos de nuestros productos, las devoluciones solo se aceptarán en caso de productos defectuosos o errores por nuestra parte. En caso de rembolso no se devolverá el dinero en su totalidad, debido a los intereses de la plataforma de pago. Por favor, contáctanos si tienes algún problema con tu pedido.
            </p>
          </section>
