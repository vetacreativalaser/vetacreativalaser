        ...
        >
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Bienvenido a Veta Creativa Laser. Estos términos y condiciones describen las reglas y regulaciones para el uso del sitio web de Veta Creativa Laser, ubicado en [URL de tu sitio web].
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              Para realizar un pedido, por favor contacta a través de los medios indicados en la web. El pago se realiza mediante Bizum o transferencia bancaria.
            </p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Los costos de envío se calcularán y comunicarán durante el proceso de pedido. El envío es gratuito para pedidos superiores a 60€.
